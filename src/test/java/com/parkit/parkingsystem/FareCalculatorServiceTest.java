...
public class FareCalculatorServiceTest {
    ...
    @Test
    @DisplayName("ticket pour 1H de stationnement pour un voiture")
    ...
    @Test
    @DisplayName("ticket pour 1H de stationnement pour une moto")
    ...
    @Test
    @DisplayName("verifie que l'exeption et levée quand il manque le type de véhicule")
    ...
    @Test
    @DisplayName("vérifie que la date sortie ne soit pas antérieur a celle de l'entrée")
    ...
    @Test
    @DisplayName("calcule le ticket pour une moto stationner 45 minute")
    ...
    @Test
    @DisplayName("calcule le ticket pour une voiture stationner 45 minute")
    ...
    @Test
    @DisplayName("ticket pour une moto avec 25 minutes de parking")
   ...
   @Test
   @DisplayName("ticket pour une voiture avec 25 minutes de parking")
   public void calculateFareCarWithLessThanTwentyFiveParkingTime(){
    ...
    @Test
    @DisplayName("calcule le ticket pour une voiture stationner 1 journée")
    ...
    @Test
    @DisplayName("calcule le ticket pour une moto stationner 1 journée")
    ...
    @Test
    @DisplayName("calcule un ticket pour une voiture stationner 45 minute avec la reduction de 5%")
    ...
    @Test
    @DisplayName("calcule un ticket pour une bike stationner 45 minute avec la reduction de 5%")
